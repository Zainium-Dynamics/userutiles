...
// ─── SHA-224 (SHA-256 with different IV, 28-byte output) ─────────────────────
...
impl Sha224 {
    pub fn new() -> Self {
        // Re-use compress by cloning logic via specialized IV through raw construction
        Self {
            inner: Sha256::with_iv([
